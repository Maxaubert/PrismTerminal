...
- **EVERY TAB IS ONE WIDTH** (owner, 2026-09-21: "make tabs in both apps have a fixed size, and not
  ...
  the same place twice. Now `flex: 0 1 106px`, min 64px ("way smaller... around 60% of what it is
  now", the same day: 176px first, which read as far too wide): one width, and all of them shrink
